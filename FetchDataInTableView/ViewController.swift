    ...
    func GetData()
    {
        ...
        URLSession.shared.dataTask(with: url!) { (Data,response,error) in
            ...
            {  if error == nil
                ...
                {  DispatchQueue.main.async {  self.TableViewS.reloadData() } }
...
extension ViewController: UITableViewDelegate, UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int { ListOfMissingPerson.count  }
